    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
        <form action="{{ route('projects.update', $project) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="judul" id="judul" value="{{ old('judul', $project->judul) }}" required
            ...
            <div>
                ...
                <input type="text" name="durasi" id="durasi" value="{{ old('durasi', $project->durasi) }}" required
            ...
            <div>
                ...
                <textarea name="deskripsi" id="deskripsi" rows="4" required
                    class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-gray-900 dark:text-gray-100">{{ old('deskripsi', $project->deskripsi) }}</textarea>
            </div>
            ...
            @if($project->dokumentasi)
                <div>
                    ...
                    <img src="{{ asset('storage/'.$project->dokumentasi) }}" alt="Current" class="w-full h-48 object-cover rounded-xl">
                </div>
            @endif
            ...
            <div>
                <label for="dokumentasi" class="block text-sm font-semibold mb-2">
                    <i class="fas fa-image text-pink-500 mr-2"></i>Dokumentasi (Image) - Leave empty to keep current
                </label>
